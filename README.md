...
これらはRFCのMessageとして定義されていて大体こういう構造
...
最初の12byteはヘッダーとなる。
```bash
aa 46 01 20 00 01 00 00  00 00 00 00
```

ヘッダーの構造は以下, bit単位で表示しているので注意
```txt
                                 1  1  1  1  1  1
 ...
 |                      ID                       |  aa 46
 +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
 |QR|   Opcode  |AA|TC|RD|RA|   Z    |   RCODE   |  01 20
 +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
 |                    QDCOUNT                    |  00 01
 +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
 |                    ANCOUNT                    |  00 00
...
Answer, Authority, Additionalセクションは**Resource Record Format**という構造で統一的されている。
